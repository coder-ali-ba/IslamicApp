...
const features = [
  ...
  },
  {
    ...
    description: "Understand the meanings and explanations behind the verses.",
    href: "/tafseer",
  },
  {
    icon: BookMarked,
    title: "Study Hadith",
    description: "Explore authentic Hadith and build your Islamic knowledge.",
    href: "/hadith",
  },
  {
    icon: GraduationCap,
  ...
  },
  {
    ...
    description: "Learn, reflect and grow together with other students.",
    href: "/community",
  },
];
          ...
          <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              ...
              >
                ...
                <circle cx="45" cy="45" r="5" fill="none" stroke="white" />
              </pattern>
            </defs>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1fr_420px] lg:gap-16">
            ...
            <div>
              ...
              <h1 className="max-w-3xl text-center text-4xl font-semibold leading-tight tracking-tight sm:text-5xl lg:text-left lg:text-6xl xl:text-7xl">
                Learn Quran.
                <br />
                <span className="text-[#d6b56d]">Understand Islam.</span>
              </h1>
              ...
              <p className="mx-auto mt-6 max-w-2xl text-center text-base leading-8 text-stone-300 sm:text-lg lg:mx-0 lg:text-left">
                ...
                learn from teachers, and build a deeper understanding of your
                faith.
              </p>
            ...
            <div className="relative mx-auto w-full max-w-[420px]">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.045] p-6 shadow-2xl backdrop-blur-md sm:p-8">
                ...
                <div className="mb-7 flex items-center justify-center gap-3">
                  ...
                  <span className="text-sm text-[#d6b56d]">✦</span>
                ...
                <div className="border-t border-white/10 pt-5">
                  <div className="mb-2 flex items-center justify-between text-xs">
                    ...
                    <span className="font-medium text-[#d6b56d]">16%</span>
                  </div>
