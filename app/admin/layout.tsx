      ...
      >
        ...
        <div className="flex h-20 items-center justify-between border-b border-white/10 px-6">
          ...
          >
            ...
            <div>
              <p className="text-lg font-semibold tracking-tight">IlmHub</p>
        ...
        {/* Navigation */}
        <nav className="flex-1 space-y-1 overflow-y-auto scrollbar-none px-4 py-6">
        ...
        <div className="border-t border-white/10 p-4">
          <div className="flex items-center gap-3 rounded-xl bg-white/5 p-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#d6b56d] font-semibold text-stone-950">
              A
            </div>
